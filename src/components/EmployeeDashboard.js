...
function EmployeeDashboard() {
    ...
    useEffect(() => {
        ...
        if (search == "") {
            Axios.get("http://localhost:3001/getemployeesforadmin", {headers:{"authorization":`bearer ${localStorage.getItem("token")}`}}).then((res) => {
    ...
    const updateList = () => {
        Axios.get(`http://localhost:3001/filteremployeesforadmin/?filter=${filter}&search=${search}`, {headers:{"authorization":`bearer ${localStorage.getItem("token")}`}}).then((response) => {
                                ...
                                return (
                                    <tr>
                                        ...
                                        <td><button style={{ color: 'red' }} onClick={() => {
                                            Axios.delete(`http://localhost:3001/deleteemployee/${val._id.valueOf()}`, {headers:{"authorization":`bearer ${localStorage.getItem("token")}`}}).then((res) => {
